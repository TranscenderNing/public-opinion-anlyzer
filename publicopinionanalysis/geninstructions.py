...
def get_data():
    # 打开并读取 JSON 文件
    with open('data06.json', 'r') as file:
        json_data = file.read()
...
# llm = OpenAI(openai_api_key="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",temperature=0)
