...
def getPrompts():
    ...
    sentiment_prompt = '''
        {content}
        Help me analyze the sentiment of the above public opinion is positive, negative, or neutral. You can only choose the answer from 'positive' or 'negative' or 'neutral'. 
    '''
    province_prompt = '''
        {content}
    ...
    '''
    keyword_prompt = '''
       Help me extract 3 keywords from the following sentence:{content}
    '''
    business_prompt = '''
        Help me extract specific business details from the following information:{content}
    '''
    impact_prompt = '''
        Help me analyze the impact on users from the following information:{content}
    '''
    major_prompt = '''
        Help me determine whether the following public opinion is a major one: 
        {content}
        Please provide your answer and reasons for your choice. You can only select 'Yes' or 'No' as your answer. 
    '''
    resolution_prompt = '''
        Help me determine whether the following public opinion requires manual follow-up and resolution:
        {content}
        Please provide your answer and reasons for your choice. You can only select 'Yes' or 'No' as your answer. 
    '''
